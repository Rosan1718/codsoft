  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isLoginMode) {
        ...
        if (success) {
          showNotification('success', 'Account created!', 'Welcome to ShopHub! You have been logged in automatically');
          onNavigate('home');
        }
      }
      
      if (!success) {
        showNotification('error', 'Authentication failed', 'Please check your credentials and try again');
      }
    } catch (error) {
      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8">
        ...
        {isLoginMode && (
          <div className="mt-4 p-4 bg-gray-50 rounded-lg">
            ...
            <p className="text-xs text-gray-500">User: user@demo.com | Admin: admin@store.com</p>
